...
export const onUserUpdate = functions.firestore
  ...
  .onUpdate(async (change, context) => {
    ...
    if (oldData.indicator_name !== newData.indicator_name) {
      ...
      indicacoesSnapshot.forEach(doc => {
        batch.update(doc.ref, {indicator_name: newData.indicator_name});
      });
      ...
      withdrawalsSnapshot.forEach(doc => {
        batch.update(doc.ref, {fullName: newData.indicator_name});
      });
      ...
      campaignsSnapshot.forEach(doc => {
        batch.update(doc.ref, {sentBy: newData.indicator_name});
      });
